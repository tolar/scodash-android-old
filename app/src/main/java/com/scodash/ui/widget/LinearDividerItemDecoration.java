...
import com.scodash.ContextProvider;
...
public class LinearDividerItemDecoration extends RecyclerView.ItemDecoration {
	...
	public LinearDividerItemDecoration(Context context, AttributeSet attrs, boolean light) {
		this(context, attrs);
		if(light) {
			setLightDividerColorFilter();
		}
	}
	...
	private void setLightDividerColorFilter() {
		int color = ContextCompat.getColor(ContextProvider.applictionContext, R.color.primaryDarkColor);
